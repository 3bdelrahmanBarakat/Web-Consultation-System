							...
							<div class="chat-window">
								...
								<div class="chat-cont-right">
									...
									<div class="chat-body">
										<div class="chat-scroll">
											<ul class="list-unstyled">
                                                ...
                                                @endif
                                                @empty
                                                <center><h2>no messages</h2></center>
                                                @endforelse
									...
									<div class="chat-footer">
										<div class="input-group">
                                            <input  type="hidden" wire:model.defer="mentor_id" value="{{$mentor_id}}">
											<input onkeydown="scrollDown()" type="text" wire:model.defer="messageText" class="input-msg-send form-control" placeholder="Type something">
