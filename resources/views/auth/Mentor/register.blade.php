						...
						<div class="account-box">
							<div class="login-right">
								<div class="login-header">
									<h3><span>MentorQuest</span> <span style="color: grey;"> || </span> Mentor Register</h3>
									<p class="text-muted">Access to our dashboard</p>
									<a id="Register-as-a-Mentee" href="{{route('mentee.register')}}">Register as a Mentee</a> <br>
								</div>
								...
								<form method="POST" action="{{ route('register') }}">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input id="first-name" type="text" class="form-control @error('fname') is-invalid @enderror" name="fname" autofocus="" required>
                                                @error('fname')
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input id="last-name" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" required>
                                                @error('lname')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
									...
									<div class="form-group">
										...
										<input id="Number" type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror" required>
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
									...
									<div class="account-footer text-center mt-3">
										Already have an account? <a style="color:#1169b1" class="forgot-link mb-0" href="{{ route('login') }}">Login</a>
									</div>
								</form>
								<!-- /Register Form -->
