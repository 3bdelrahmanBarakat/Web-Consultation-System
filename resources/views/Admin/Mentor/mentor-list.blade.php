										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
                                                ...
                                                <tr>
													...
													<td>${{$mentor['bookings_sum_total_fees']}}</td>

													<td>
                                                        <div class="status-toggle d-flex justify-content-center">
                                                            <input type="checkbox" id="status_{{$mentor['id']}}" class="check" {{$mentor['is_activated'] ? 'checked' : ''}}>
                                                            <label for="status_{{$mentor['id']}}" class="checktoggle">checkbox</label>
                                                        </div>
                                                    </td>
												</tr>
