...
<html lang="en">
	...
	<body>
		...
		<div class="main-wrapper">
			...
			<header class="header">
				...
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									<li><a href="#mentoring_flow">How does it work?</a></li>
									<li><a href="#popular_mentors">Popular Mentors</a></li>
									<li><a href="#paths">Our Paths</a></li>
					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item">
							<a class="nav-link" href="{{ route('mentee.mentor_search') }}">Mentors</a>
						</li>
						<li class="nav-item">
				...
				<div class="container">
					<div class="banner-wrapper m-auto text-center aos" data-aos="fade-up">
						<div class="banner-header">
							<h1>Find The Best <span>Mentor In Our Platform</span></h1>
							<p>Your Satisfaction Is Our <span style="color: #1e88e5">Quest</span>.</p>
						</div>
			...
			<section class="section how-it-works" id="mentoring_flow">
				<div class="container">
			...
			<section class="section popular-courses" id="popular_mentors">
				<div class="container">
					<div class="section-header text-center aos" data-aos="fade-up">
			...
			<!-- Path section start -->
			<section class="section path-section" id="paths">
				<div class="section-header text-center aos" data-aos="fade-up">
					<div class="container">
				...
				<div class="learning-path-col">
					<div class="container">
						...
						<div class="view-all text-center aos" data-aos="fade-up"><a href="search.html" class="btn btn-primary">View All</a></div>
					</div>
				</div>
			</section>
			<!-- Path section end -->
			...
			<!-- Blog Section -->
		   <section class="section section-blogs" id="blogs">
				<div class="container">
