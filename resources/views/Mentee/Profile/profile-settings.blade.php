									...
									<form>
										<div class="row form-row">
											...
											<div class="">
												<div class="form-group">
													<label> Name</label>
													<input type="text" class="form-control" value="abdelrahman">
												</div>
											</div>
											...
											<div class="">
												<div class="form-group">
													<label>Email </label>
													<input type="email" class="form-control" value="a@a.com">
												</div>
											</div>
											<div class="">
												<div class="form-group">
													<label>Username </label>
													<input type="text" class="form-control" value="jonathandoe_2">
												</div>
											</div>
											<div class="">
												<div class="form-group">
												...
												<a class="blue-btn" href="reset-password.html">Change Password</a>
											</div>
