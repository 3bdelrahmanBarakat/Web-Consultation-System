						...
						<div class="col-md-7 col-lg-8">
							<div class="card">
								<div class="card-body">
									...
									<!-- Checkout Form -->
									<form action="{{route('mentee.booking.process-payment')}}" method="POST">
                                        @csrf
											...
											<div class="row">
												<div class="col-md-6 col-sm-12">
													<div class="form-group card-label">
														<label>Name</label>
														<input disabled class="form-control" value="{{ Auth::user()->name }}" type="text">

                                                        <input type="hidden" name="total_fees" value="{{$mentor_fees}}">
                                                        ...
                                                        <input type="hidden" name="message4" value="{{$message4}}"> --}}
													</div>
												</div>
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group card-label">
														<label>Email</label>
														<input disabled class="form-control" value="{{ Auth::user()->email }}" type="email">
													</div>
												</div>
												{{-- <div class="col-md-6 col-sm-12">
													<div class="form-group card-label">
										...
										<div class="payment-widget">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group card-label">
															...
															<input class="form-control" maxlength="16" id="card_number" name="card_number" placeholder="1234  5678  9876  5432" type="text">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group card-label">
															<label for="expiry_month">Expiry Month</label>
															<input class="form-control" maxlength="2" id="expiry_month" name="expiry_month" placeholder="MM" type="text">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group card-label">
															<label for="expiry_year">Expiry Year</label>
															<input class="form-control" maxlength="4" id="expiry_year" name="expiry_year" placeholder="YY" type="text">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group card-label">
															<label for="cvv">CVV</label>
															<input class="form-control" maxlength="3" id="cvv" name="expiry_year" type="text">
														</div>
													</div>
												</div>
											</div> --}}
											...
											<div class="terms-accept">
													...
													<div class="custom-checkbox">
													   ...
													   <label for="terms_accept">Save credit Card Information </label>
											...
											<div class="submit-section mt-4">
												{{-- <button type="submit" class="btn btn-primary submit-btn">Confirm and Pay</button> --}}
                                                    ...
                                                    <script
                                                                            ...
                                                                            data-key="pk_test_51N3DLUAiwUowPMZ6hLNpkqjmnoG4jkYcTHrrwOzADc24JqT5xmMGMrGzeZ2nhbxrfSq2nxu8eWoNCT7PH1YQ1SaG00kopHUyar" <!-- Your Stripe public key -->
                                                                            // data-amount="1000"
                                                                            data-name="Mentorship Consultation"
								...
								<div class="card-body">
									...
									<div class="booking-user-info">
										<a href="profile.html" class="booking-user-img">
											<img src="{{ url('public/Image/'.$mentor['about']->photo) }}" alt="User Image">
										</a>
										<div class="booking-info">
											<h4><a href="profile.html">{{$mentor['fname']}} {{$mentor['lname']}}</a></h4>
											<div class="rating">
									...
									<div class="booking-summary">
										<div class="booking-item-wrap">
											<ul class="booking-date">
												<li>Date <span>5 May 2023</span></li>
												<li>Time <span>10:00 AM</span></li>
											</ul>
											{{-- <ul class="booking-fee">
												<li>Consulting Fee <span>${{$mentor_fees}}</span></li>
											...
											<div class="booking-total">
												<ul class="booking-total-list">
													<li>
														<span>Total</span>
														<span class="total-cost">${{$mentor_fees}}</span>
													</li>
												</ul>
											</div>
										</div>
