										...
										<div class="row form-row">
												...
												<div class="form-group">
													<div class="change-avatar">
														<div class="profile-img">
															<img src="{{ url('public/Image/'.$about->photo) }}" alt="User Image">
														</div>
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													...
													<div class="cal-icon">
														<input type="date" name="date_of_birth" class="form-control datetimepicker" value="{{$about->date_of_birth}}">
													</div>
												</div>
											</div>
											{{-- <div class="col-12 col-md-6">
											...
											<div class="col-12 col-md-12">
												<div class="form-group">
													...
													<input type="text" name="years_of_experience" class="form-control" value="{{$experience->years_of_experience}}">
												</div>
											</div>
											{{-- <div class="col-12 col-md-6">
												<div class="form-group">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input name="start_date" type="date" class="form-control datetimepicker" value="{{$experience->start_date}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input name="end_date" type="date" class="form-control datetimepicker" value="{{$experience->end_date}}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label>Country</label>
                                                    <input type="text" name="country" class="form-control" value="{{$about->country}}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="zip_code" class="form-control" value="{{$about->zip_code}}">
                                                </div>
                                            </div>
											{{-- <div class="col-12">
												<div class="form-group">
												<label>Bio</label>
												<textarea name="bio" cols="150" rows="7" placeholder="Write your Bio"></textarea>
												</div>
											</div> --}}
										</div>
                                        <a href="{{route('mentor.reset-password')}}">Change Password</a> <br><br>
