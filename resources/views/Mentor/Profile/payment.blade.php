				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<h2 class="breadcrumb-title">Payment Setup</h2>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content">
				<div class="container-fluid">
                    ...
                    @endif
									...
									<form action="{{route('mentor.payment.store')}}" method="POST">
                                        @csrf
										<div class="row form-row">
											...
											<div class="col-12 col-md-6">
												<div class="form-group">
													...
													<input required type="text" name="account_holder_name" class="form-control">
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label>Routing Number</label>
													<input required type="number" name="routing_number" class="form-control">
												</div>
											</div>
											<div class="col-12 col-md-6">
												<div class="form-group">
													<label>Account Number</label>
													<input required type="number" name="account_number" class="form-control">
												</div>
											</div>
										...
										<div class="submit-section">
											<button type="submit" class="btn btn-primary submit-btn">Save Payment</button>
										</div>
									</form>
									<!-- /Profile Settings Form -->
