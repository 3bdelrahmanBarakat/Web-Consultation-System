...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>MentorQuest - Reviews</title>
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="doc-review review-listing">
								...
								<ul class="comments-list">
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="{{asset('assets/img/user/user.jpg')}}">
											<div class="comment-body">
												<div class="meta-data">
													<span class="comment-author">{{$review['mentee']['username']}}</span>
