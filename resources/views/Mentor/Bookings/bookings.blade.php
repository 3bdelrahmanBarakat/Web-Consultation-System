...
<html lang="en">
	...
	<body>
							...
							<div class="appointments">
								...
								<div class="appointment-list">
									...
									<div class="appointment-action">
										...
										<a href="#" class="btn btn-sm bg-success-light" data-bs-toggle="modal" data-bs-target="#accept_details{{$booking->id}}">
											<i class="fas fa-check"></i> Accept
										</a>
										<a href="#" class="btn btn-sm bg-danger-light" data-bs-toggle="modal" data-bs-target="#reject_details{{$booking->id}}">
        ...
        <div class="modal fade custom-modal" id="accept_details{{$booking->id}}">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						...
						<ul class="info-details">
							<li>
								<div class="details-header">
									<div class="row">
										<div class="col-md-12">
											<h5 class="title">Are you sure you want to accept this booking?</h5>
										</div>
										<br><br>
										...
										<div class="col-md-6">
											<div class="text-end">
												<form action="{{route('bookings.accept',$booking->id)}}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn bg-success-light btn" id="topup_status">Yes</button>
                                                </form>
											</div>
										</div>
									</div>
        ...
        <div class="modal fade custom-modal" id="reject_details{{$booking->id}}">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						...
						<ul class="info-details">
							<li>
								<div class="details-header">
									...
									<div class="row">
										<div class="col-md-12">
											<h5 class="title">Why do you want to reject this booking?</h5>
										</div>

                                        <div class="col-md-12">
                                            <textarea name="rejection_message" id="" cols="60" rows="4"></textarea>
                                        </div>
										<br><br>
										...
										<div class="col-md-6">
											<div class="text-end">
                                                    ...
                                                    @csrf
                                                    <button type="submit" class="btn bg-danger-light btn" id="topup_status">Reject</button>
                                                </div>
                                            </form>
										</div>
									</div>
