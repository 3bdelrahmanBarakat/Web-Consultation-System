							...
							<div class="chat-window">
										...
										<div class="chat-scroll">
											...
											<a href="{{route('mentee.chat',$mentor['mentor_id'])}}" class="media d-flex">
												...
												<div class="media-body flex-grow-1">
													<div>
														<div class="user-name">{{$mentor['mentor']['fname']}} {{$mentor['mentor']['lname']}}</div>
														{{-- <div class="user-last-chat">Hey, How are you?</div> --}}
													</div>
													<div>
														{{-- <div class="last-chat-time block">2 min</div> --}}
														<div class="badge badge-success badge-pill fill-blue rounded-pill">1</div>
													</div>
												</div>
											</a>
                                            @endforeach
								...
								<div class="chat-cont-right">
									...
									<div class="chat-body">
										<div class="chat-scroll">
                                            <br><br><br>
                                            <center><h2>Select Mentor to start </h2></center>
										</div>
									</div>
